...
function crushthree() {
    ...
    for (let r = 0; r < rows; r++) {
        for (let c = 0; c < columns - 2; c++) {
            ...
            if (candy1.src == candy2.src && candy2.src == candy3.src && !candy1.src.includes("blank")) {
                ...
                score += 30; // optional: increment score
            }
        }
    }
    ...
    // vertical
    for (let c = 0; c < columns; c++) {
        // r must stop at rows-2 so r+1 and r+2 are valid
...
function slidecandy() {
    for (let c = 0; c < columns; c++) {
        ...
        let writeRow = rows - 1;  // last row index

        // move candies DOWN
        for (let r = rows - 1; r >= 0; r--) {

            if (!board[r][c].src.includes("blank")) {
                board[writeRow][c].src = board[r][c].src;
                writeRow--;
            }
        }

        // fill remaining cells with blank
